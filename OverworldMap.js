  ...
  Office: {
    ...
    configObjects: {
            ...
            events: [
              {
                ...
                text: 'Career 2021 to Present </br></br> Northcoders - Software engineer and seminar lead </br></br> Kev leads a small team for Northcoders. Remotely delivering the curriculum of full-stack software development seminars to a group of 30+ students, he guides and mentors the group through the full 13 week course as well as upskilling mentors and junior developers </br></br> Also as part of the Northcoders internal development team, he has worked on many Northcoders projects, which are now being used daily by both students and tutors. These projects include: Learner management system, Learn 2 Code platform, Northcoders React component library. More details can be found by clicking on the Northcoders protrait in this room.',
              },
              {
                type: 'displayImageAndText',
      ...
      ncPainting: {
        ...
        x: utils.withGrid(5),
        y: utils.withGrid(-1),
        description: "Slides describing Kev's 'dev' work at Northcoders",
        src: '/assets/paintings/nc.png',
        imgSrc: [
          '/assets/paintings/kevDevAgile800.png',
          '/assets/paintings/kevDevL2C800.png',
          '/assets/paintings/kevDevRCL800.png',
          '/assets/paintings/kevDevLMS800.png',
          '/assets/paintings/kevDevCertGen800.png',
          '/assets/paintings/kevDevPairGen800.png',
        ],
      },
      mum: {
        type: 'Person',
